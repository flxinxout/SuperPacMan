...
/**
 * [EXTENSION] Copy of the Level 0 of the game but with heart extension
 */
public class Level0Copy extends SuperPacmanArea {
    ...
    protected void createArea() {
        ...
        Door door = new Door("superpacman/Level1Copy", new DiscreteCoordinates(15, 6), Logic.TRUE, this,
